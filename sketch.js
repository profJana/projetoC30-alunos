...
function setup() {
  ...
  //código correto para que ao clicar no breakButton chama o evento mousePressed para executar a função handleButtonPress
  //breakButton.mousePressed(handleButtonPress);
  //breakButton(handleButtonPress);
  //breakButton.mousePressed();
  //breakButtonmousePressed(handleButtonPress);
}
...
function handleButtonPress() {
  ...
  //após 1500 milisegundos (1.5 segundos) quebrar a ponte (bridge.break())
